...
class AppColors {
  ...
  static const Color btncolor = Color(0xff00162A);
  static const Color iconinbtncolor = Color(0xff015B49);
  static const Color errorcolor = Color(0xff08082C);

  static const List<Color> backgroundGradientone = [
    Color(0xff00162A),
    Color(0xff002A34),
    Color(0xff015B49),
  ];
  ...
  static final List<Color> errorcolordetails = [
    errorcolor,
    errorcolor,
  ];
